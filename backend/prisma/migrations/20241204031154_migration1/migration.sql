...
-- AddForeignKey
ALTER TABLE `peminjaman` ADD CONSTRAINT `peminjaman_id_barang_fkey` FOREIGN KEY (`id_barang`) REFERENCES `Inventori`(`id_barang`) ON DELETE RESTRICT ON UPDATE CASCADE;
